"""アバランシェ検出と臨界性指標を合成データで検算する (Beggs & Plenz 2003 の 4 指標)。
...
def test_analyze_avalanches_end_to_end():
    """臨界分岐過程のスパイク列で解析一式が走り、既知の指数と σ を復元できること。"""
    ...
    avalanches, _lags, _corr, metrics = avalanche.analyze_avalanches(
